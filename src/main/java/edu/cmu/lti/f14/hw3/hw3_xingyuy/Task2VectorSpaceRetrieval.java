...
public class Task2VectorSpaceRetrieval {
	...
	public static void main(String[] args) throws Exception {
		...
		URL descUrl = Task2VectorSpaceRetrieval.class.getResource("/descriptors/retrievalsystem/task2/Task2VectorSpaceRetrieval.xml");
		if (descUrl == null) {
		...
		URL docUrl = Task2VectorSpaceRetrieval.class.getResource("/data/documents.txt");
		if (docUrl == null) {
