...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.11791.f14.hw3.typesystems.Token");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.11791.f14.hw3.typesystems.Token");
  ...
  public int getFrequency(int addr) {
      ...
      jcas.throwFeatMissing("frequency", "edu.cmu.lti.11791.f14.hw3.typesystems.Token");
